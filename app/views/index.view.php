...
//    // prepare a valid sql statement for the server db
//    // prepare to INSERT some VALUES into emails table
//    // execute the statement while passing $data
//    // $data "email" => $_POST["email"] is equal to  the value of the 'email' form input 

//    // pass columns email created_at
//    $statement = $pdo->prepare("INSERT INTO emails (email,created_at, updated_at) VALUES (:email, now(), now())");

//    $newEmail = $statement->execute($data);
//    //  dd($newEmail);
//    // if $newEmail is good/ truthy, then return user to thank you page
//    if ($newEmail) {
//     header('Location: '. 'http://localhost:8080/ThankYou.php');
//    }

//   } else {
//     // a php script will show a div
//     $formError = true;
//     // no need to run dd('Error, Empty Input'); php script
//   }
// }
